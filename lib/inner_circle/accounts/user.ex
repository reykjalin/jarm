defmodule InnerCircle.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_display_name(changeset) do
    ...
    |> unsafe_validate_unique(:display_name, InnerCircle.Repo)
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, InnerCircle.Repo)
  ...
  """
  def valid_password?(%InnerCircle.Accounts.User{hashed_password: hashed_password}, password)
